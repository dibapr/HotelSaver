        ...
        <View style={style.container}>
            <View >
                ...
                <View >
                    ...
                    <TextInput name="checkIn" placeholder="checkIn" style={style.textInput} onChangeText={(checkIn) => {
                        setCheckIn(checkIn)
                        console.log(checkIn);
                    }} value={checkIn} />
                </View>
                <View>
                    ...
                    <TextInput name="checkOut" placeholder="checkOut" style={style.textInput} onChangeText={(checkOut) => {
